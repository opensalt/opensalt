...
class ImportTxCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('import:tx')
            ->setDescription('Import TX Learning Standards CSV file from EdPlan IMS')
            ->addArgument('filename', InputArgument::REQUIRED, 'TX Learning Standards File')
        ;
    }
