...
final class Version20191210200643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE salt_association_subtype (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, parent_type VARCHAR(255) NOT NULL, inverse_parent TINYINT(1) NOT NULL, description VARCHAR(512) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
INSERT INTO salt_association_subtype
    (name, parent_type, inverse_parent, description)
VALUES
    ('{$subType['name']}', '{$subType['parentType']}', {$subType['inverseParent']}, '{$subType['description']}')
;
            ");
        }
    }
