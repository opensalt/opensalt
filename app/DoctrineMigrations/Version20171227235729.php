...
class Version20171227235729 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE audit_ls_def_grade (id INT NOT NULL, rev INT NOT NULL, identifier VARCHAR(300) DEFAULT NULL, uri VARCHAR(300) DEFAULT NULL, extra JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', updated_at DATETIME(6) DEFAULT NULL COMMENT \'(DC2Type:datetime)\', title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, rank INT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_45e38822f0d366b3b685da14d9e5debb_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_ls_def_concept (id INT NOT NULL, rev INT NOT NULL, identifier VARCHAR(300) DEFAULT NULL, uri VARCHAR(300) DEFAULT NULL, extra JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', updated_at DATETIME(6) DEFAULT NULL COMMENT \'(DC2Type:datetime)\', title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, hierarchy_code VARCHAR(255) DEFAULT NULL, keywords LONGTEXT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_75324ebee3373577889b17bc22abf34e_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_salt_org (id INT NOT NULL, rev INT NOT NULL, name VARCHAR(255) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_59b3da2b9e2bcba5d4a77563efc38235_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_salt_user (id INT NOT NULL, rev INT NOT NULL, org_id INT DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, password VARCHAR(64) DEFAULT NULL, roles JSON DEFAULT NULL COMMENT \'(DC2Type:json_array)\', locked TINYINT(1) DEFAULT \'0\', github_token VARCHAR(40) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_46f55645cc7f32a05776ae6c103d5adb_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_salt_user_doc_acl (user_id INT NOT NULL, doc_id INT NOT NULL, rev INT NOT NULL, access SMALLINT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_8112d0e5935d0790cc5f0299a2408621_idx (rev), PRIMARY KEY(user_id, doc_id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_revision (id INT AUTO_INCREMENT NOT NULL, timestamp DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', username VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
