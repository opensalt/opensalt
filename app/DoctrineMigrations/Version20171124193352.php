 ...
 */
class Version20171124193352 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE salt_comment ADD document_id INT NOT NULL, ADD item_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE salt_comment ADD item VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('UPDATE salt_comment SET item = CONCAT("document:", document_id)');
        $this->addSql('UPDATE salt_comment SET item = CONCAT("item:", item_id)');
