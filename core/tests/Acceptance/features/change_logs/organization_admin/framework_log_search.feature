Feature: Change Log Interaction
  ...
  @0117-0703 @logs @ui @group-admin @duplicate
  Scenario: 0117-0703 Searching for an item in the search form shows the table of data elements with those item rows - Logged in as Group Admin
