Feature: Change Log Interaction
  ...
  @incomplete @0117-0702 @logs @ui @group-admin @duplicate
  Scenario: 0117-0702 Add new item, Update of an item, Move item shows the table of data elements - Logged in as Group Admin
