Feature: Change Log Interaction
  ...
  @0117-0704 @logs @ui @group-admin @duplicate
  Scenario: 0117-0704 User should see 25 rows in the data table when 25 selected from the Show Entries selected - Logged in as Group Admin
