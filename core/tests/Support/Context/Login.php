...
use Tests\Support\Page\LoginLocal;
...
class Login implements Context
{
    ...
    public function iLogANew($role) {
      ...
      $admin->does(function (\Tests\Support\AcceptanceTester $I) use ($role){
        $login = new \Tests\Support\Context\Login($I);
    ...
    protected function getLoginPage(): \Tests\Support\Page\Login
    {
