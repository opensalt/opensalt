...
final readonly class LsAssociationNormalizer implements NormalizerInterface
{
    use LinkUriTrait;
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): ?array
    {
        ...
        $ret = [
            ...
            'notes' => $case10 ? null : Collection::emptyToNull($data->getNotes()),
            'extensions' => $case10 ? null : array_merge($data->getExtensions(), ['subtype' => Collection::emptyToNull($data->getSubtype())]),
        ];
    ...
    private function createOutLink(LsAssociation $association, string $which, array $context, bool $addType = true): ?array
    {
