...
final readonly class LsDocNormalizer implements NormalizerInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): ?array
    {
        ...
        $ret = [
            ...
            'caseVersion' => $case10 ? null : Collection::emptyToNull($data->getCaseVersion()),
            ...
            'officialSourceURL' => Collection::emptyToNull($data->getOfficialUri()),
            'CFPackageURI' => $this->createPackageLinkUri($data, 'LsDoc', $context),
            'publisher' => Collection::emptyToNull($data->getPublisher()),
            ...
            'version' => Collection::emptyToNull($data->getVersion()),
            'adoptionStatus' => Collection::emptyToNull($data->getAdoptionStatus()),
            ...
            'notes' => Collection::emptyToNull($data->getNote()),
