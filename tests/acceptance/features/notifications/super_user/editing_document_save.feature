...
When another user finishes editing the document then I see all of the buttons are enabled
  ...
  @0108-0804 @change-notification @ui @super-user @duplicate
  Scenario: 0108-0804 Notification for document finished editing and when logged in as an Super-User
